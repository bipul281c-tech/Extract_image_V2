                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    <div className="text-center space-y-6 max-w-4xl mx-auto mb-12">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                            Extract <strong className="text-foreground">image links</strong> from any website instantly. Get direct image URLs, copy image links, and download images from links with our powerful image link extractor. Free, fast, and easy to use. Need step-by-step guidance? Check our{" "}
                            <Link href="/how-to-get-an-image-url" className="text-primary hover:underline font-semibold">
                                how-to guide
                            </Link>. Want to download images instead? Use our{" "}
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <UseCaseCard
                            ...
                            description="Extract image links for web scraping projects, data collection, or automated workflows. Get structured image URL data for processing. For extracting from multiple sites, use our <Link href='/bulk-extractor' className='text-primary hover:underline'>bulk extractor</Link>."
                        />
                        <UseCaseCard
                        ...
                        <UseCaseCard
                            ...
                            description="Extract image links for website migrations, testing, or development. Get all image URLs for backup or replication purposes. Need to download the actual images? Try our <Link href='/image-downloader' className='text-primary hover:underline'>image downloader</Link>."
                        />
                        <UseCaseCard
