                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    <div className="text-center space-y-6 max-w-4xl mx-auto mb-12">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                            The most powerful <strong className="text-foreground">bulk image extractor</strong> to download images from multiple websites simultaneously. Process hundreds of URLs, extract thousands of images, and save everything with one click.
                        </p>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <UseCaseCard
                            ...
                            description="Gather images from multiple sources for academic research, market analysis, or competitive intelligence. Extract product images, infographics, and visual data at scale."
                        />
                        <UseCaseCard
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            Traditional methods of downloading images from multiple websites are tedious and time-consuming. Our bulk extractor automates the entire process, letting you focus on what matters.
                        </p>
