...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        type: "website",
        url: "https://www.extractpics.com/download-image",
        siteName: "ExtractPics",
        images: [
            {
                url: "https://www.extractpics.com/og-image-download-image.png",
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ["https://www.extractpics.com/og-image-download-image.png"],
    },
    alternates: {
        canonical: "https://www.extractpics.com/download-image",
    },
    robots: {
        index: true,
        follow: true,
                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    <div className="text-center space-y-6 max-w-4xl mx-auto mb-12">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                            The fastest way to <strong className="text-foreground">download images</strong> from any website. Extract, preview, and save images in seconds. Download single images or bulk download entire collections with one click.
                        </p>
