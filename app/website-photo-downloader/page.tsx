                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    <div className="text-center space-y-6 max-w-4xl mx-auto mb-12">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                            The most powerful <strong className="text-foreground">website photo downloader</strong> tool. Extract, preview, and save photos from any website in seconds with <Link href="https://www.extractpics.com/" className="text-primary hover:underline font-semibold">ExtractPics</Link>. Download single photos or bulk download entire collections.
                        </p>
