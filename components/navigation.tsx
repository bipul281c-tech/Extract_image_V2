    ...
    return (
        <nav className="fixed top-0 w-full z-50 border-b border-border bg-background/80 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                ...
                <div className="hidden lg:flex items-center gap-1 text-xs font-medium absolute left-1/2 -translate-x-1/2">
                    {navigationGroups.map((group) => (
                        ...
                        >
                            <button className="flex items-center gap-1 px-3 py-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors">
                                {group.label}
                            ...
                            {/* Dropdown Menu */}
                            <div
                                className={`absolute top-full left-0 mt-1 w-56 bg-popover border border-border rounded-lg shadow-lg overflow-hidden transition-all duration-200 ${openDropdown === group.label
